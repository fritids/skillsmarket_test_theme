...
function sm_insights_dashboard_widget_template_function() {
	...
	'<div id="smInsightsDashboard" class="insights-inside">
		<header>
			<h2>Welcome back, <span class="user_name">'.$current_user->display_name.'</span>
		</header>
		<div class="content">
...
function add_sm_insights_dashboard_widget() {
	...
	$dashboard_header = 
	'</span>
	<div id="holder-left">Insights Dashboard</div>
	<div id="holder-right">
	<a href="http://www.theskillsmarket.org/" target="_blank">
	<img src="'.get_template_directory_uri().'/growth-hacks/assets/logo.png" id="sm_logo" height="40">
	</a>
	</div>
	<span>';
